	...
	<div class="c2a grid-container-fluid grid-x">
		...
		<div class="section__bg-height--normal align-center cell small-12 medium-12 large-10 large-offset-1">
			<div class="section__c2a-inner grid-x grid-margin-x">
				...
				<div class="cell section__info section__info--center section__bg-color--text-<?php echo $c2a_bg_color['label']; ?> small-9 small-offset-1 medium-9 medium-offset-1 large-5 large-offset-0 ">
					<h2 class="section__title less-margin--top"><?php echo $c2a_title; ?></h2>
					<div class="section__bg-color--text-<?php echo $c2a_bg_color['label']; ?> cell small-11 small-offset-0 medium-8 medium-offset-1 large-8 large-offset-0 "><?php echo $c2a_text; ?></div>
