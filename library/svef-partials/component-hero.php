						...
						<div class="cell small-12 medium-12 large-5 grid-x ">
							<div class="section__info section__info--center cell small-9 small-offset-1 medium-9 medium-offset-1 large-10 large-offset-1 ">
								...
								<div class="section__info--text">
									...
									<p class="section__paragraphTall--off text-color--<? echo $hero_background_color['value'];?> small-10 small-offset-1 medium-offset-1 large-offset-0"><?php echo $hero_slider_text; ?></p>
								</div>
			...
			<div class="cell small-12 medium-12 large-5 grid-x ">
				<div class="section__info cell small-10 small-offset-1 medium-10 medium-offset-1 large-10 large-offset-1">
					...
					<div>
						...
						<p class="section__paragraphTall--off text-color--<? echo $hero_background_color['value'];?> small-10 small-offset-1 medium-offset-1 large-offset-0"><?php echo $hero_text; ?></p>
